          ...
          <div>
            ...
            >
              <p className="text-sm" style={{ color: "#444ec1" }}>
                <strong>Note:</strong> The suggestions below were generated by AI analyzing your experience and job description to spark ideas and help you recall impactful moments. These examples won't carry forward automatically—you choose what to use in upcoming sections. If you have experiences that better highlight your capabilities, you're encouraged to draw on those instead.
              </p>
            </div>
          </div>
        )}
