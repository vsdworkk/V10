...
export default function PitchWizardLayout({
  ...
  return (
    <div className="relative min-h-screen bg-gradient-to-br from-blue-50 via-white to-purple-50">
      ...
      <div
        id="main-container"
        className="flex items-stretch justify-center p-4 sm:p-12"
      >
        <div
          id="application-card"
          className="bg-white rounded-3xl shadow-2xl border border-gray-100 overflow-hidden w-full max-w-6xl flex flex-col md:flex-row"
        >
          {/* Progress for small screens */}
          ...
          <div
            id="sidebar"
            className="hidden md:flex w-72 border-r border-gray-100 bg-white p-8 items-center shadow-lg"
          >
            <SectionProgressSidebar
              current={currentSection}
              maxCompleted={maxCompletedSection}
          ...
          <section
            id="main-content"
            className="flex-1 p-4 sm:p-5 md:h-[800px] overflow-y-auto"
          >
            {children}
          </section>
        </div>
