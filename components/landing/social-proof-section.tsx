...
export async function SocialProofSection() {
    return (
        <section className="pt-4 pb-16 md:pt-8 md:pb-32">
            <div className="mx-auto max-w-6xl space-y-8 px-6 md:space-y-16">
                <div className="relative z-10 mx-auto max-w-xl space-y-6 text-center md:space-y-12">
                    <h2 className="text-4xl font-semibold lg:text-5xl">What our users are saying</h2>
                </div>
                    ...
                    <Card className="grid grid-rows-[auto_1fr] gap-8 sm:col-span-2 sm:p-6 lg:row-span-2">
                        <CardContent>
                            <blockquote className="grid h-full grid-rows-[1fr_auto] gap-6">
                                <p className="text-xl font-medium">Applying for a role, I had no idea how to write a statement of claims, it was overwhelming. I stumbled upon APSPitchPro, it was super easy to use. All I had to do was answer a couple simple questions and it did all the complex APS alignment, and wrote a pitch unique to my experience. I highly recommend it to anyone unsure where to start and wants to land more APS interviews!</p>
                                ...
                                <div className="grid grid-cols-[auto_1fr] items-center gap-3">
                                    ...
                                    <div>
                                        ...
                                        <span className="text-muted-foreground block text-sm">APS Applicant</span>
                                    </div>
                                </div>
                            </blockquote>
                        </CardContent>
