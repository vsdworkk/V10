        ...
        <div className="relative mt-12 md:mt-20">
          <Card className="relative mx-auto max-w-sm lg:max-w-full">
            <div className="grid lg:grid-cols-3">
              ...
              <div className="ring-foreground/10 bg-background -mx-1 rounded-lg border-transparent shadow ring-1 lg:-my-3">
                <div className="relative px-1 lg:px-0 lg:py-3">
                  <CardHeader className="p-8">
                  ...
                  <div className="-mx-1 border-y px-8 py-4 lg:mx-0">
